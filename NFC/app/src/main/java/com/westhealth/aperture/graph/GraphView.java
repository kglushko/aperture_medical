...
public class GraphView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private final int mDipPadding, mFillColor, mAxisColor, mStrokeSpacing, mBackgroundColor;
    private final float mStrokeWidth;
    private ArrayList<Line> mLines = new ArrayList<Line>();
    private Paint mPaint = new Paint();
    private float mMinY = 0, mMinX = 0, mMaxY = 0, mMaxX = 0;
    private double mRangeYRatio = 0, mRangeXRatio = 0;
    ...
    public GraphView(Context context, AttributeSet attrs) {
        ...
        mFillColor = R.color.lineColor;
        mAxisColor =  Color.parseColor("#1997a9");
        mBackgroundColor = Color.parseColor("#1997a9");
    ...
    public class GraphThread extends Thread {
        ...
        public GraphThread(SurfaceHolder surfaceHolder)
        {
            ...
            for (Line line : mLines) {
                ...
                if (line.isShowingPoints()) {
                    for (LinePoint p : line.getPoints()) {
                        ...
                        path.reset();
                        outerRadius *= 2;
                        path.addCircle(xPixels, yPixels, outerRadius, Path.Direction.CW);
